...
<div id="reporte">
  ...
  <a href="imprimirReporte.php?tid=<?php echo $terreno_id; ?>&cid=<?php echo $caso_id; ?>" target="_blank">Versión Para Impresión <img src="images/print-preview.png" border="0" alt="Versión Para Impresión" width="25" /></a>
  ...
  <table>
  	<thead>
        ...
        <th>Estaci&oacute;n Clim&aacute;tica:</th>
...
<?php
	...
	function getCostoTotal( $tid, $cid ) {
		...
		$result = mysql_fetch_array(mysql_query("SELECT id_pqt_caso FROM ce_casos_". $tid . "t WHERE caso = ". $cid ." LIMIT 1;"));
